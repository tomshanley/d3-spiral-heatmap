...
// segmentLabels: an array of labels that will be placed around the circumference of the spiral
...
function spiralHeatmap() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var segmentLabelsG = thisSelection
      ...
      segmentLabelsG
        ...
        .style("text-anchor", function(d, i) {
          return i < segmentLabel.length / 2 ? "start" : "end";
        });
  ...
  chart.segmentLabel = function(value) {
    if (!arguments.length) return segmentLabel;
    segmentLabel = value;
    return chart;
  };
